...
async function starts() {
	...
	await nzwa.connect({timeoutMs: 30*1000})
        ...
        console.log('=> 𝐓𝐨𝐱𝐢𝐜 V1')
        lolcatjs.fromString('[𝐓𝐨𝐱𝐢𝐜] Hola gracias por usar mi bot, espero te guste ;)')
	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			const isCmd = body.startsWith(prefix)
                        ...
                        mess = {
							...
							only: {
								...
								daftarB: `──「 NO ESTÁS REGISTRADO 」──\nSuscribete al canal: https://www.youtube.com/channel/UC8yq2vREgBFz5Vi_51QNX9g \n Usa el comando: ${prefix}register para registrarte\nEjemplo: ${prefix}register 𝐓𝐨𝐱𝐢𝐜|99`,
                                }
                        }
					const apakah = ['Si','Nel']
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '17694447624@s.whatsapp.net'
